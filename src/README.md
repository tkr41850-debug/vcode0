...
- Prefer package barrels for cross-package public contract imports. Internal package files should import local contract modules directly rather than routing through their own public barrel.
