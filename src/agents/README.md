...
- **Planner / replanner** — behavior, prompts, and graph-mutation tools used during planning. Tooling surface now splits across typed hosts, schemas, and builder modules under [`tools/`](./tools/README.md).
