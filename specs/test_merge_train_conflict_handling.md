...
Capture how integration-stage rebase and merge-train verification failures are handled during feature integration.
...
### Merge-train verification failure also ejects the feature
...
- And it is no longer merge-ready until repair work lands and feature verification passes again
...
- And the feature may return to `work_complete`
