...
Audit candidate (not an implementation candidate). Surfaced from the [2026-04-29 deep-dive synthesis](../compare/2026-04-29-deep-dive-synthesis.md).
...
- Topic pages: [overstory.md](../compare/overstory.md), [2026-04-29 deep-dive](../compare/2026-04-29-deep-dive-synthesis.md).
...
- Considered skipping the audit entirely. Rejected: the moat strength claim is asserted in [overstory.md](../compare/overstory.md), and the assertion is cheap to verify.
