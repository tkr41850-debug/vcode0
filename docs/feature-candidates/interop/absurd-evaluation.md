...
This page now serves as the historical record of the evaluation question and outcome. Originally surfaced from the [2026-04-29 deep-dive synthesis](../../compare/landscape/2026-04-29-deep-dive-synthesis.md).
...
- Topic pages: [durable-execution.md](../../compare/research/durable-execution.md), [pi-ecosystem-post-earendil.md](../../compare/research/pi-ecosystem-post-earendil.md).
...
- Considered evaluating LangGraph for the same role. Rejected: LangGraph's checkpointing is between-step only, which is *worse* than gvc0's current model for in-flight tool calls. See [durable-execution.md](../../compare/research/durable-execution.md).
