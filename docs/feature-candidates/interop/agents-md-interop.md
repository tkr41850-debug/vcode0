...
Future feature candidate. Surfaced from the [2026-04-29 deep-dive synthesis](../../compare/landscape/2026-04-29-deep-dive-synthesis.md).
...
- **Future harness portability.** If gvc0 ships a non-pi-sdk harness (per [claude-code-harness.md](../runtime/claude-code-harness.md) or beyond), AGENTS.md is the format that just works.
...
- Topic page: [agents-md-and-aaif.md](../../compare/research/agents-md-and-aaif.md).
