...
- [Feature Candidate: Centralized Conversation Persistence](../runtime/centralized-conversation-persistence.md) — nearby persistence and recovery trade-offs
- [Feature Candidate: Distributed Runtime](../runtime/distributed-runtime.md) — future portability and recovery concerns across machines
