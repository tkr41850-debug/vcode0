...
### Working on planning, graph, or state semantics
...
- [Architecture / Persistence](./architecture/persistence.md)
- [Architecture / Planner](./architecture/planner.md)
- [Architecture / Budget and Model Routing](./architecture/budget-and-model-routing.md)

## Operations

- [Operations Topics](./operations/README.md)
- [Operations / Verification and Recovery](./operations/verification-and-recovery.md)
- [Operations / Conflict Coordination](./operations/conflict-coordination.md)
...
- [Reference Topics](./reference/README.md)
